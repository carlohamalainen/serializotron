...
exampleOrganization = Organization
  ...
  , budgetAllocations = Map.fromList
      [ (("exec", "eng"), 250000.0)
      , (("exec", "sales"), 180000.0)
...
exampleTournament = Tournament
  ...
  , participants = Map.fromList
      [ ("alice", Participant "alice" ExpertLevel 
      ...
      , ("bob", Participant "bob" (IntermediateLevel 0.75)
  ...
  , currentState = CompetitionState "alice" 1 
